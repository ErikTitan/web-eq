...
<template>
  ...
  <div class="py-6 px-6 lg:px-20 mx-0 my-12 lg:mx-20 rounded-[20px] " style="background: linear-gradient(0deg, 
    ...
    <div class="flex flex-col justify-center items-center text-center px-4 py-4 md:py-0">
      <div class="mb-2 text-3xl font-semibold" style="color: var(--p-text-color)">Andrej Šima</div>
      <span class="text-2xl" style="color: var(--p-text-muted-color)">Professional War Thunder Player</span>
      <p class="sm:line-height-2 md:line-height-4 text-2xl mt-6" style="max-width: 1000px; color: var(--p-text-color)">
