...
<template>
  ...
  <div class="flex flex-col pt-24 px-6 lg:px-20 overflow-hidden" style="background: linear-gradient(0deg, 
    ...
    <div class="mx-6 md:mx-20 mt-0 md:mt-6">
      ...
      <Button label="Create Your First Preset" severity="primary" rounded class="!text-xl mt-8 !px-4"></Button>
    </div>
  ...
  <div class="py-6 px-6 lg:px-20 mx-0 my-12 lg:mx-20">
    <div class="text-center">
      <div class="font-normal mb-2 text-4xl">Audio Excellence Anywhere</div>
      <span class=" text-2xl">Professional-grade equalizer in your browser. No downloads
        needed.</span>
    </div>

    <div class="grid grid-cols-12 gap-4 mt-20 pb-2 md:pb-20">
      <div class="flex justify-center col-span-12 lg:col-span-6 p-0 order-1 lg:order-none rounded-lg"
        style="background: var(--gradient-gaming)">
        <img src="../assets/images/hyperx_transparent.png" class="w-11/12" />
      </div>

      <div class="col-span-12 lg:col-span-6 my-auto flex flex-col lg:items-end text-center lg:text-right gap-4">
        <div class="flex items-center justify-center self-center lg:self-end rounded-xl"
          style="width: 4.2rem; height: 4.2rem; background: var(--gradient-gaming)">
          <i class="pi pi-fw pi-trophy !text-4xl text-white"></i>
        </div>
        <div class="leading-none text-3xl font-normal">Gaming-Optimized Presets</div>
        <span class="text-2xl leading-normal ml-0 md:ml-2" style="max-width: 650px">
    ...
    <div class="grid grid-cols-12 gap-4 my-20 pt-2 md:pt-20">
      <div class="col-span-12 lg:col-span-6 my-auto flex flex-col text-center lg:text-left lg:items-start gap-4">
        <div class="flex items-center justify-center self-center lg:self-start rounded-xl"
          style="width: 4.2rem; height: 4.2rem; background: var(--gradient-audio)">
          <i class="pi pi-fw pi-headphones !text-3xl text-white"></i>
        </div>
        <div class="leading-none text-3xl font-normal">Headphone Perfection</div>
        <span class="text-2xl leading-normal mr-0 md:mr-2" style="max-width: 650px">
      ...
      <div class="flex justify-center order-1 sm:order-2 col-span-12 lg:col-span-6 rounded-lg"
        style="background: var(--gradient-audio)">
        <img src="../assets/images/sennheiser_transparent.png" class="w-11/12" />
      </div>
    </div>
  </div>

  <div class="container mt-20 mb-20 md:p-20 mx-auto rounded-[20px]" style="background: linear-gradient(0deg, 
            var(--overlay),
            var(--overlay)),
            var(--gradient-testimonial)">
    <div class="flex flex-col justify-center items-center text-center px-4 py-4 md:py-0">
      <div class="mb-2 text-3xl font-semibold">Andrej Šima</div>
      <span class="text-2xl">Professional War Thunder Player</span>
      <p class="sm:line-height-2 md:line-height-4 text-2xl mt-6" style="max-width: 1000px">
        "WEB-EQ has revolutionized how I approach audio tuning. The ability to create and share presets instantly has
        made it my go-to tool for quick adjustments during gaming sessions and music production. The precision and ease
        of use are unmatched in the browser-based audio space."
      </p>

    </div>
    <div class="flex flex-col justify-center items-center text-center pt-6">
